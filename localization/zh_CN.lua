return {
	["misc"] = {
		...
		v_text = {
			ch_c_ortalab_only = {'只启用 {C:Ortalab}Ortalab{} 内容'},
            ch_c_ortalab_chaosC = { "所有 {C:attention}商店物品{} 都有相同的概率" },
            ch_c_ortalab_lostC = { "在每个赌注结束时，获得一个 {C:attention}焚化补丁{}" },
            ch_c_ortalab_diseasedC = { "所有小丑都是 {C:infected}受感染的{}" },
			ch_c_ortalab_russianC = { "所有小丑都是 {C:possessed}被附身的{}" },
            ch_c_ortalab_ephermeralC = { "所有小丑都是 {C:attention}易腐烂的{}" },
        },
		["dictionary"] = {
			...
			['ortalab_config_reduced'] = '更小的模组标记',
			['ortalab_config_reduced_desc'] = {
				"切换模组标识符的",
				"大小"
			},
			['ortalab_config_ortalab_only'] = '仅切换Ortalab',
			...
			ortalab_config_loteria_skip = '彩票',
			ortalab_config_loteria_skip_desc = {
				'跳过',
				'大多数彩票卡的动画'
			},
			ortalab_config_enhancement_skip = '强化',
			...
			['ortalab_copied'] = '已复制！',
			ortalab_cutout = '切！',
			ortalab_polydactyly = '方便！',
			ortalab_street_rat = 'Got \'em!',
			ortalab_memorial = '纪念！',
			ortalab_crowd_pleaser_success = '完成！',
			ortalab_none = '无',
			ortalab_hand_legendary = '无法指定传奇',
			['ortalab_na'] = '无',
			['ortalab_explode'] = '爆炸！',
			['ortalab_infected'] = '感染！',
			['ortalab_destroyed'] = '摧毁！',
			...
			['ortalab_no_tag'] = '无',
			['ortalab_flashback'] = '回忆！',
			['ortalab_joker_miles'] = '升级！',
			['ortalab_joker_miles_reset'] = '重置！',
			['ortalab_sinker_message'] = '-1手牌数！',
			['ortalab_hammer'] = '剥离！',
			['ortalab_corroded'] = '腐蚀！',
			['ortalab_loteria_saved'] = '保存！',
			ortalab_protostar = '坍塌！',
			ortalab_level_up = '升级！',
			ortalab_cured = '治愈！',
			ortalab_spike_debuff = '手牌将被减益！',
			ortalab_fork_cap = '分数上限为50%',
			ortalab_tongs = '+2%',
			ortalab_minimised = '最小化！',
			ortalab_rank = '特定点数',
			ortalab_zodiac_add = '+1星座',
			ortalab_loteria_add = '+1彩票',
			ortalab_cardist = '+1手牌！',
			ortalab_jackalope = '+1弃牌！',
			ortalab_jackalope_hand = '+1手牌数！',
			ortalab_forklift = '+2槽位',
			ortalab_forklift_loss = '-2槽位',
			ortalab_zodiac_upgraded = ' 升级！',
			ortalab_zodiac_added = ' 添加！',
			ortalab_zodiac_active = ' 激活！',
			ortalab_zodiac_no_decay = '无衰减！',
			ortalab_back = '让我玩！',
			ortalab_blind_no_rank = '无点数',
			ortalab_blind_no_rank_caps = '无点数',
			ortalab_joker_slot = ' 小丑槽位！',
			ortalab_joker_slots = ' 小丑槽位！',
			ortalab_hand_size_gain = '+1手牌数！',
			ortalab_infected_safe = '安全！',
			ortalab_edition_plus = '一个版本',
			k_tag = '标签',
			k_ortalab_zodiac = '星座',
			b_ortalab_zodiac_cards = '星座卡',
			k_ortalab_loteria = '彩票',
			b_ortalab_loteria_cards = '彩票卡',
			k_ortalab_mythos = 'Mythos',
			b_ortalab_mythos_cards = '神话卡',
			ortalab_chisel = '凿出！',
			ortalab_statue = '雕像！',
			ortalab = 'Ortalab',
			ortalab_policeman = '+4弃牌！',
			ortalab_score = '分数：',
			ortalab_stake_skips = '需要跳过：',
			blind_credit = '添加自 ',
			ortalab_celadon_notification = ' 被减益',
			...
			ortalab_art_credit = "艺术作者 ",
			ortalab_shader_credit = '着色器作者 ',
			ortalab_curse_credit = '诅咒艺术作者 ',
			ortalab_mod_badge = '添加自 ',
			ortalab_corpus_activated = '你释放了圣体的力量',
			ortalab_corpus_sacrifice = '献祭',
			ortalab_sand_crumble = '崩溃！',
			ortalab_curses = '诅咒',
			ortalab_collected = '收集！',
			ortalab_attached = '附加！',
			ortalab_koko = '嘿嘿！',
			ortalab_ophiuchus = '净化！',
			ortalab_plural = 's',
			ortalab_comma = ', '
		},
		['labels'] = {
			...
			ortalab_anaglyphic = '立体',
			ortalab_corroded = '腐蚀',
			ortalab_possessed = '附身',
			ortalab_restrained = '束缚',
			ortalab_infected = '感染',
			ortalab_cyan_seal = '青色封蜡',
			ortalab_magenta_seal = '品红封蜡'
		},
		challenge_names = {
			c_ortalab_chaosC = "混沌",
			c_ortalab_rich_kidC = "富家子弟",
			c_ortalab_ambidexrousC = "双手灵巧",
			c_ortalab_blackC = "安息于画中",
			c_ortalab_copyC = "复制复制猫",
			c_ortalab_evil_upC = "邪恶升级！",
			c_ortalab_lostC = "迷失与焚化",
			c_ortalab_diseasedC = "疾病",
			c_ortalab_russianC = "俄罗斯轮盘",
			c_ortalab_ephermeralC = "短暂",
			c_ortalab_policeC = "撤退",
			c_ortalab_cursedC = "诅咒！",
			c_ortalab_fingersC = "穿过你的手指",
			c_ortalab_starsC = "命运多舛",
			c_ortalab_freezerC = "别打开冰箱",
			c_ortalab_shinkuC = "真空盗梦空间",
			c_ortalab_shrodingerC = "薛定谔",
			c_ortalab_locked_inC = "锁定",
			c_ortalab_rustyC = "生锈的针",
    ...
    ["descriptions"] = {
		Mod = {
			ortalab = {
				name = 'Ortalab',
				text = {
					'这是你熟知的 {C:blue}Balatro{}，但是倒过来，侧过来，',
					'就像游戏是在另一个宇宙中设计的一样。',
					'简单来说，这是 {C:blue}Balatro{}，{C:attention}倒过来{}。',
					'因此，{C:Ortalab}Ortalab！',
					' ',
					'拥有 {C:green}150{} 个新小丑，{C:green}20{} 个新挑战，{C:green}8{} 个新难度，',
					'{C:green}50多{} 个新消耗品，以及更多更多，',
					'{C:Ortalab}Ortalab{} 实际上是 {C:blue}Balatro{} 的续作。',
					' ',
					'准备好寻找新策略，打破游戏，',
					'也许这次不会死于植物。',
					' ',
